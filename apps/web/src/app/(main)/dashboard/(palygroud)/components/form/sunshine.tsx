...
import { SunshineAction } from '../../actions/sunshine'
...
export function SunshineForm() {
  const [lastResult, action, isPending] = useActionState(SunshineAction, null)
  const [form, fields] = useForm({
    constraint: getZodConstraint(sunshineSchema),
    lastResult,
    onValidate({ formData }) {
      return parseWithZod(formData, { schema: sunshineSchema })
    },
